...
addRainbowTitleToLocalPlayer(LP, "XI团队出品必是精品")
...
-- 创建UI
local WindUI = loadstring(game:HttpGet("https://pastefy.app/3nbAifj0/raw"))()
...
local AP, AS, AT, Au, IF
Tg(A, "自动击球", nil, false, function(t) AP = t end)
Tg(A, "自动连击", nil, false, function(t) AS = t end)
Tg(A, "自动闪避", nil, false, function(t) AT = t end)
...
game["Run Service"].Heartbeat:Connect(function()
    ...
    local DY = ball.zoomies and ball.zoomies.VectorVelocity or ball.AssemblyLinearVelocity
